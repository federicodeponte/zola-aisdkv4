...
export const API_ROUTE_PROMPT_QUEUE_ENQUEUE = "/api/prompt-queue/enqueue"
export const API_ROUTE_PROMPT_QUEUE_CANCEL = "/api/prompt-queue/cancel"
export const API_ROUTE_PROMPT_QUEUE_STATUS = "/api/prompt-queue/status"
